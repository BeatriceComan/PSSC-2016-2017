...
{/*
    ...
    public class DefinedSubject : Subject
    {
        ...
        public DefinedSubject(int subjectId, PlainText subjectName, Credits credits, EvaluationType examType, Common.Professor.Professor professor,
             Dictionary<Common.Student.Student, ViewableSituation> enrolledStudents) : base(subjectId, subjectName, credits)
        {
            ExamType = examType;
            Professor = professor;
        ...
        public DefinedSubject(int subjectId, PlainText subjectName, Credits credits, EvaluationType examType, Common.Professor.Professor professor, 
            ...
            : this(subjectId, subjectName, credits, examType, professor, proportion)
        {
            _enrolledStudents = enrolledStudents;
        }

        public DefinedSubject(int subjectId, PlainText subjectName, Credits credits, EvaluationType examType, Common.Professor.Professor professor, 
            Proportion proportion) : base(subjectId, subjectName, credits)
        {
            ExamType = examType;
            Professor = professor;
