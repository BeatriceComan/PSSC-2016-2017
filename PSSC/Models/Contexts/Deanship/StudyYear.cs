...
namespace Models.Contexts.Deanship
{
    ...
    public class StudyYear : Entity<Guid>
    {
        ...
        public void DefineSubject(int subjectId, PlainText subjectName, Credits credits, Dictionary<Common.Student.Student, ViewableSituation> enrolledStudents,
            EvaluationType type, Common.Professor.Professor professor, Proportion prop)
        {
            ...
            _definedSubjects.Add(new DefinedSubject(subjectId, subjectName, credits, type, professor, prop, enrolledStudents));
        }
            ...
            EvaluationType type, Common.Professor.Professor professor)
        {
            ...
            _definedSubjects.Add(new DefinedSubject(subjectId, subjectName, credits, type, professor, enrolledStudents));
        }
