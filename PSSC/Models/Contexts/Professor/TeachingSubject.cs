...
namespace Models.Contexts.Professor
{
    ...
    public class TeachingSubject : Subject
    {
        ...
        public TeachingSubject(Dictionary<Common.Student.Student, GradeableSituation> enrolledStudents, int subjectId, PlainText subjectName, Credits credits)
            : base(subjectId, subjectName, credits)
        {
